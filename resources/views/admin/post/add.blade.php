                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="important" class="form-control @error('important') is-invalid @enderror">
                                                <option value="0" {{ old('important', 0) == 0 ? 'selected' : '' }}>Not important</option>
                                                <option value="1" {{ old('important', 0) == 1 ? 'selected' : '' }}>Important</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="published" class="form-control @error('published') is-invalid @enderror">
                                                <option value="0" {{ old('published', 0) == 0 ? 'selected' : '' }}>Unpublished</option>
                                                <option value="1" {{ old('published', 0) == 1 ? 'selected' : '' }}>Published</option>
                                            </select>
